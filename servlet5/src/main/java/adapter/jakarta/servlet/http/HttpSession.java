 ...
 *
 * <p>Use {@code adapter.jakarta.servlet5.http.HttpSession} instead. 본 클래스는 v2.0
 * 에서 제거됩니다. 원본 {@code adapter.jakarta.servlet5.http.HttpSession} 의 생성자가
 * package-private 이므로 상속이 불가능하여 동일한 인터페이스를 구현하는 composition
 * delegate 형태로 제공합니다.
 */
...
public class HttpSession implements jakarta.servlet.http.HttpSession, AdapterUnwrap<javax.servlet.http.HttpSession> {
    ...
    @Override public ServletContext getServletContext() {
        return new adapter.jakarta.servlet5.ServletContext(this.httpSession.getServletContext());
    }
