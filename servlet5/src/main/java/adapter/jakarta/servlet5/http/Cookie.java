...
public class Cookie extends jakarta.servlet.http.Cookie implements Cloneable, AdapterUnwrap<javax.servlet.http.Cookie> {
   ...
   // @req FR-CONV-003
   @Override public javax.servlet.http.Cookie unwrap() {
      return this.cookie;
   }
