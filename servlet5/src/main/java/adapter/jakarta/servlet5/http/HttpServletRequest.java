...
import adapter.jakarta.servlet5.ServletRequest;
...
public class HttpServletRequest extends ServletRequest implements jakarta.servlet.http.HttpServletRequest {
   ...
   @Override public boolean authenticate(jakarta.servlet.http.HttpServletResponse arg0) throws IOException, ServletException {
      try {
         return this.httpRequest.authenticate(new adapter.javax.servlet5.http.HttpServletResponse(arg0));
   ...
   @Override public Collection<jakarta.servlet.http.Part> getParts() throws IOException, ServletException {
      try {
         ...
         if (jakartaParts == null) return null;
   ...
   @Override public <T extends HttpUpgradeHandler> T upgrade(Class<T> handlerClass) throws ServletException {
       try {
          adapter.javax.servlet5.http.HttpUpgradeHandler.setJakartaUpgradeHandlerClass(handlerClass);
          adapter.javax.servlet5.http.HttpUpgradeHandler handler = this.httpRequest.upgrade(adapter.javax.servlet5.http.HttpUpgradeHandler.class);
          jakarta.servlet.http.HttpUpgradeHandler  httpUpgradeHandler = new adapter.jakarta.servlet5.http.HttpUpgradeHandler(handler);
