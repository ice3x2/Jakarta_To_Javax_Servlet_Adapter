 ...
 *
 * <p>Use {@code adapter.javax.servlet5.ServletRegistration} instead. 본 클래스는 v2.0
 * 에서 제거됩니다.
 */
@Deprecated(since = "1.0.0", forRemoval = true)
public class ServletRegistration extends adapter.javax.servlet5.ServletRegistration {
