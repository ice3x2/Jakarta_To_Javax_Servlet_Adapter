...
import adapter.javax.servlet5.ServletRequest;
import adapter.servletElementConverter5.AsyncContextConverter;
...
public class HttpServletRequest extends ServletRequest implements javax.servlet.http.HttpServletRequest {
   ...
   @Override public RequestDispatcher getRequestDispatcher(String path) {
      return new adapter.javax.servlet5.RequestDispatcher(this.httpRequest.getRequestDispatcher(path));
   }
   ...
   @Override public ServletContext getServletContext() {
      return new adapter.javax.servlet5.ServletContext(this.httpRequest.getServletContext());
   }
   ...
   @Override public boolean authenticate(javax.servlet.http.HttpServletResponse response) throws IOException, ServletException {
      try {
         return this.httpRequest.authenticate(new adapter.jakarta.servlet5.http.HttpServletResponse(response));
