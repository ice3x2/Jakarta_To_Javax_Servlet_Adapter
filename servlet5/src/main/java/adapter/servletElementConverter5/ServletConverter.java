...
public class ServletConverter {
   ...
   public static jakarta.servlet.Registration convert(javax.servlet.Registration ori) {
      if (ori instanceof javax.servlet.ServletRegistration.Dynamic) {
         return new adapter.jakarta.servlet5.ServletRegistrationDynamic((javax.servlet.ServletRegistration.Dynamic)ori);
      } else if (ori instanceof javax.servlet.ServletRegistration) {
         return new adapter.jakarta.servlet5.ServletRegistration((javax.servlet.ServletRegistration)ori);
      } else if (ori instanceof javax.servlet.FilterRegistration.Dynamic) {
         return new adapter.jakarta.servlet5.FilterRegistrationDynamic((javax.servlet.FilterRegistration.Dynamic)ori);
      } else if (ori instanceof javax.servlet.FilterRegistration) {
         return new adapter.jakarta.servlet5.FilterRegistration((javax.servlet.FilterRegistration)ori);
      } else {
         return ori instanceof javax.servlet.Registration.Dynamic ? new adapter.jakarta.servlet5.RegistrationDynamic((javax.servlet.Registration.Dynamic)ori) : new adapter.jakarta.servlet5.Registration(ori);
      }
   }


   public static adapter.jakarta.servlet5.ServletRegistrationDynamic convert(javax.servlet.ServletRegistration.Dynamic ori) {
      return new adapter.jakarta.servlet5.ServletRegistrationDynamic(ori);
   }

   public static adapter.jakarta.servlet5.ServletRegistration convert(javax.servlet.ServletRegistration ori) {
      return new adapter.jakarta.servlet5.ServletRegistration(ori);
   }

   public static adapter.jakarta.servlet5.FilterRegistrationDynamic convert(javax.servlet.FilterRegistration.Dynamic ori) {
      return new adapter.jakarta.servlet5.FilterRegistrationDynamic(ori);
   }

   public static adapter.jakarta.servlet5.FilterRegistration convert(javax.servlet.FilterRegistration ori) {
      return new adapter.jakarta.servlet5.FilterRegistration(ori);
   }

   public static adapter.jakarta.servlet5.RegistrationDynamic convert(javax.servlet.Registration.Dynamic ori) {
      return new adapter.jakarta.servlet5.RegistrationDynamic(ori);
   }
   ...
   public static javax.servlet.Registration convert(jakarta.servlet.Registration ori) {
      if (ori instanceof jakarta.servlet.ServletRegistration.Dynamic) {
         return new adapter.javax.servlet5.ServletRegistrationDynamic((jakarta.servlet.ServletRegistration.Dynamic)ori);
      } else if (ori instanceof jakarta.servlet.ServletRegistration) {
         return new adapter.javax.servlet5.ServletRegistration((jakarta.servlet.ServletRegistration)ori);
      } else if (ori instanceof jakarta.servlet.FilterRegistration.Dynamic) {
         return new adapter.javax.servlet5.FilterRegistrationDynamic((jakarta.servlet.FilterRegistration.Dynamic)ori);
      } else if (ori instanceof jakarta.servlet.FilterRegistration) {
         return new adapter.javax.servlet5.FilterRegistration((jakarta.servlet.FilterRegistration)ori);
      } else {
         return ori instanceof jakarta.servlet.Registration.Dynamic ? new adapter.javax.servlet5.RegistrationDynamic((jakarta.servlet.Registration.Dynamic)ori) : new adapter.javax.servlet5.Registration(ori);
      }
   }

   public static javax.servlet.ServletRegistration convert(jakarta.servlet.ServletRegistration.Dynamic ori) {
      return new adapter.javax.servlet5.ServletRegistrationDynamic(ori);
   }

   public static javax.servlet.ServletRegistration convert(jakarta.servlet.ServletRegistration ori) {
      return new adapter.javax.servlet5.ServletRegistration(ori);
   }

   public static javax.servlet.FilterRegistration convert(jakarta.servlet.FilterRegistration.Dynamic ori) {
      return new adapter.javax.servlet5.FilterRegistrationDynamic(ori);
   }

   public static javax.servlet.FilterRegistration convert(jakarta.servlet.FilterRegistration ori) {
      return new adapter.javax.servlet5.FilterRegistration(ori);
   }
   ...
   public static javax.servlet.FilterConfig convert(final jakarta.servlet.FilterConfig filterConfig) {
      return new javax.servlet.FilterConfig() {
         ...
         public javax.servlet.ServletContext getServletContext() {
            return new adapter.javax.servlet5.ServletContext(filterConfig.getServletContext());
         }
   ...
   public static jakarta.servlet.FilterConfig convert(final javax.servlet.FilterConfig filterConfig) {
      return new jakarta.servlet.FilterConfig() {
         ...
         public jakarta.servlet.ServletContext getServletContext() {
            return new adapter.jakarta.servlet5.ServletContext(filterConfig.getServletContext());
         }
   ...
   public static jakarta.servlet.ServletConfig convert(final javax.servlet.ServletConfig config) {
      return new jakarta.servlet.ServletConfig() {
         ...
         public jakarta.servlet.ServletContext getServletContext() {
            return new adapter.jakarta.servlet5.ServletContext(config.getServletContext());
         }
   ...
   public static javax.servlet.ServletConfig convert(final jakarta.servlet.ServletConfig config) {
      return new javax.servlet.ServletConfig() {
         ...
         public javax.servlet.ServletContext getServletContext() {
            return new adapter.javax.servlet5.ServletContext(config.getServletContext());
         }
