...
import adapter.jakarta.servlet6.ServletRequest;
...
public class HttpServletRequest extends ServletRequest implements jakarta.servlet.http.HttpServletRequest {
   ...
   @Override public boolean authenticate(jakarta.servlet.http.HttpServletResponse arg0) throws IOException, ServletException {
      try {
         return this.httpRequest.authenticate(new adapter.javax.servlet6.http.HttpServletResponse(arg0));
   ...
   @Override public <T extends HttpUpgradeHandler> T upgrade(Class<T> handlerClass) throws ServletException {
       try {
          adapter.javax.servlet6.http.HttpUpgradeHandler.setJakartaUpgradeHandlerClass(handlerClass);
          adapter.javax.servlet6.http.HttpUpgradeHandler handler = this.httpRequest.upgrade(adapter.javax.servlet6.http.HttpUpgradeHandler.class);
          jakarta.servlet.http.HttpUpgradeHandler  httpUpgradeHandler = new adapter.jakarta.servlet6.http.HttpUpgradeHandler(handler);
