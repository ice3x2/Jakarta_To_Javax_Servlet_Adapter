...
import adapter.javax.servlet6.ServletRequest;
...
public class HttpServletRequest extends ServletRequest implements javax.servlet.http.HttpServletRequest {
   ...
   @Override public RequestDispatcher getRequestDispatcher(String path) {
      return new adapter.javax.servlet6.RequestDispatcher(this.httpRequest.getRequestDispatcher(path));
   }
   ...
   @Override public ServletContext getServletContext() {
      return new adapter.javax.servlet6.ServletContext(this.httpRequest.getServletContext());
   }
   ...
   @Override public boolean authenticate(javax.servlet.http.HttpServletResponse response) throws IOException, ServletException {
      try {
         return this.httpRequest.authenticate(new adapter.jakarta.servlet6.http.HttpServletResponse(response));
   ...
   @Override public <T extends HttpUpgradeHandler> T upgrade(Class<T> handlerClass) throws ServletException {
      try {
         adapter.jakarta.servlet6.http.HttpUpgradeHandler.setJakartaUpgradeHandlerClass(handlerClass);
         adapter.jakarta.servlet6.http.HttpUpgradeHandler handler = this.httpRequest.upgrade(adapter.jakarta.servlet6.http.HttpUpgradeHandler.class);
         javax.servlet.http.HttpUpgradeHandler  httpUpgradeHandler = new adapter.javax.servlet6.http.HttpUpgradeHandler(handler);
