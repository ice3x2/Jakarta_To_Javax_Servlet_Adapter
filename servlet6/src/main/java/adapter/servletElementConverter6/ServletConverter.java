package adapter.servletElementConverter6;
...
public class ServletConverter {
   ...
   public static jakarta.servlet.Registration convert(javax.servlet.Registration ori) {
      if (ori instanceof javax.servlet.ServletRegistration.Dynamic) {
         return new adapter.jakarta.servlet6.ServletRegistrationDynamic((javax.servlet.ServletRegistration.Dynamic)ori);
      } else if (ori instanceof javax.servlet.ServletRegistration) {
         return new adapter.jakarta.servlet6.ServletRegistration((javax.servlet.ServletRegistration)ori);
      } else if (ori instanceof javax.servlet.FilterRegistration.Dynamic) {
         return new adapter.jakarta.servlet6.FilterRegistrationDynamic((javax.servlet.FilterRegistration.Dynamic)ori);
      } else if (ori instanceof javax.servlet.FilterRegistration) {
         return new adapter.jakarta.servlet6.FilterRegistration((javax.servlet.FilterRegistration)ori);
      } else {
         return ori instanceof javax.servlet.Registration.Dynamic ? new adapter.jakarta.servlet6.RegistrationDynamic((javax.servlet.Registration.Dynamic)ori) : new adapter.jakarta.servlet6.Registration(ori);
      }
   }


   public static adapter.jakarta.servlet6.ServletRegistrationDynamic convert(javax.servlet.ServletRegistration.Dynamic ori) {
      return new adapter.jakarta.servlet6.ServletRegistrationDynamic(ori);
   }

   public static adapter.jakarta.servlet6.ServletRegistration convert(javax.servlet.ServletRegistration ori) {
      return new adapter.jakarta.servlet6.ServletRegistration(ori);
   }

   public static adapter.jakarta.servlet6.FilterRegistrationDynamic convert(javax.servlet.FilterRegistration.Dynamic ori) {
      return new adapter.jakarta.servlet6.FilterRegistrationDynamic(ori);
   }

   public static adapter.jakarta.servlet6.FilterRegistration convert(javax.servlet.FilterRegistration ori) {
      return new adapter.jakarta.servlet6.FilterRegistration(ori);
   }

   public static adapter.jakarta.servlet6.RegistrationDynamic convert(javax.servlet.Registration.Dynamic ori) {
      return new adapter.jakarta.servlet6.RegistrationDynamic(ori);
   }
   ...
   public static javax.servlet.Registration convert(jakarta.servlet.Registration ori) {
      if (ori instanceof jakarta.servlet.ServletRegistration.Dynamic) {
         return new adapter.javax.servlet6.ServletRegistrationDynamic((jakarta.servlet.ServletRegistration.Dynamic)ori);
      } else if (ori instanceof jakarta.servlet.ServletRegistration) {
         return new adapter.javax.servlet6.ServletRegistration((jakarta.servlet.ServletRegistration)ori);
      } else if (ori instanceof jakarta.servlet.FilterRegistration.Dynamic) {
         return new adapter.javax.servlet6.FilterRegistrationDynamic((jakarta.servlet.FilterRegistration.Dynamic)ori);
      } else if (ori instanceof jakarta.servlet.FilterRegistration) {
         return new adapter.javax.servlet6.FilterRegistration((jakarta.servlet.FilterRegistration)ori);
      } else {
         return ori instanceof jakarta.servlet.Registration.Dynamic ? new adapter.javax.servlet6.RegistrationDynamic((jakarta.servlet.Registration.Dynamic)ori) : new adapter.javax.servlet6.Registration(ori);
      }
   }

   public static javax.servlet.ServletRegistration convert(jakarta.servlet.ServletRegistration.Dynamic ori) {
      return new adapter.javax.servlet6.ServletRegistrationDynamic(ori);
   }

   public static javax.servlet.ServletRegistration convert(jakarta.servlet.ServletRegistration ori) {
      return new adapter.javax.servlet6.ServletRegistration(ori);
   }

   public static javax.servlet.FilterRegistration convert(jakarta.servlet.FilterRegistration.Dynamic ori) {
      return new adapter.javax.servlet6.FilterRegistrationDynamic(ori);
   }

   public static javax.servlet.FilterRegistration convert(jakarta.servlet.FilterRegistration ori) {
      return new adapter.javax.servlet6.FilterRegistration(ori);
   }
   ...
   public static javax.servlet.FilterConfig convert(final jakarta.servlet.FilterConfig filterConfig) {
      return new javax.servlet.FilterConfig() {
         ...
         public javax.servlet.ServletContext getServletContext() {
            return new adapter.javax.servlet6.ServletContext(filterConfig.getServletContext());
         }
   ...
   public static jakarta.servlet.FilterConfig convert(final javax.servlet.FilterConfig filterConfig) {
      return new jakarta.servlet.FilterConfig() {
         ...
         public jakarta.servlet.ServletContext getServletContext() {
            return new adapter.jakarta.servlet6.ServletContext(filterConfig.getServletContext());
         }
   ...
   public static jakarta.servlet.ServletConfig convert(final javax.servlet.ServletConfig config) {
      return new jakarta.servlet.ServletConfig() {
         ...
         public jakarta.servlet.ServletContext getServletContext() {
            return new adapter.jakarta.servlet6.ServletContext(config.getServletContext());
         }
   ...
   public static javax.servlet.ServletConfig convert(final jakarta.servlet.ServletConfig config) {
      return new javax.servlet.ServletConfig() {
         ...
         public javax.servlet.ServletContext getServletContext() {
            return new adapter.javax.servlet6.ServletContext(config.getServletContext());
         }
   ...
   public static jakarta.servlet.SessionCookieConfig convert(final javax.servlet.SessionCookieConfig ori) {
      return new jakarta.servlet.SessionCookieConfig() {
         ...
         public void setAttribute(String name, String value) {
            // placeholder pending PH-004 — setAttribute added in Servlet 6.0 SessionCookieConfig
         }
         ...
         public java.util.Map<String, String> getAttributes() {
            // placeholder pending PH-004 — getAttributes added in Servlet 6.0 SessionCookieConfig
