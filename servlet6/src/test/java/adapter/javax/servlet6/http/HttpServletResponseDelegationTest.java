...
/**
 * javax-side {@link adapter.javax.servlet6.http.HttpServletResponse} 단위 위임 테스트.
 *
...
class HttpServletResponseDelegationTest {
    ...
    // ----------------------------------------------------------------------
    // AC-2 위임 검증 #1: deprecated setStatus(int, String) — Servlet 6.0 에서 reason
    ...
    // ----------------------------------------------------------------------
    // AC-2 위임 검증 #2: deprecated encodeRedirectUrl — Servlet 6.0 에서 메서드가
