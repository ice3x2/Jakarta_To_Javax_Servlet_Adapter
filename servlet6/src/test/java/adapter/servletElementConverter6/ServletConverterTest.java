...
/**
 * {@link adapter.servletElementConverter6.ServletConverter} 의
 ...
 *       {@code adapter.jakarta.servlet6.ServletRegistrationDynamic}</li>
 *   <li>{@code instanceof javax.servlet.ServletRegistration} &rarr;
 *       {@code adapter.jakarta.servlet6.ServletRegistration}</li>
 *   <li>{@code instanceof javax.servlet.FilterRegistration.Dynamic} &rarr;
 *       {@code adapter.jakarta.servlet6.FilterRegistrationDynamic}</li>
 *   <li>{@code instanceof javax.servlet.FilterRegistration} &rarr;
 *       {@code adapter.jakarta.servlet6.FilterRegistration}</li>
 *   <li>{@code instanceof javax.servlet.Registration.Dynamic} &rarr;
 *       {@code adapter.jakarta.servlet6.RegistrationDynamic}</li>
 *   <li>else (base Registration) &rarr;
 *       {@code adapter.jakarta.servlet6.Registration}</li>
 * </ol>
 *
 ...
 * polymorphic SSOT 가드이다 (계획 §3.PH-005.T-PH005-03 action).
 *
 * <p><b>FR-CONV-010 default 분기 페어 가드 (계획 §3.PH-005.T-PH005-03 action)</b>:
...
class ServletConverterTest {
    ...
    void shouldConvertServletRegistrationDynamic_AC1() {
        // ---- 분기 1: javax.servlet.ServletRegistration.Dynamic → adapter.jakarta.servlet6.ServletRegistrationDynamic
        ...
        assertTrue(result1 instanceof adapter.jakarta.servlet6.ServletRegistrationDynamic,
        ...
        // ---- 분기 2: javax.servlet.ServletRegistration (non-Dynamic) → adapter.jakarta.servlet6.ServletRegistration
        ...
        assertTrue(result2 instanceof adapter.jakarta.servlet6.ServletRegistration,
            "분기 2 (ServletRegistration) 는 jakarta ServletRegistration 어댑터로 dispatch 되어야 한다 "
            + "(actual=" + result2.getClass().getName() + ")");
        assertTrue(!(result2 instanceof adapter.jakarta.servlet6.ServletRegistrationDynamic),
            "분기 2 는 non-Dynamic 분기여야 한다 (Dynamic 으로 잘못 dispatch 되면 분기 1 이 선점된 것)");

        // ---- 분기 3: javax.servlet.FilterRegistration.Dynamic → adapter.jakarta.servlet6.FilterRegistrationDynamic
        ...
        assertTrue(result3 instanceof adapter.jakarta.servlet6.FilterRegistrationDynamic,
            "분기 3 (FilterRegistration.Dynamic) 은 jakarta FilterRegistrationDynamic 어댑터로 dispatch 되어야 한다 "
            + "(actual=" + result3.getClass().getName() + ")");

        // ---- 분기 4: javax.servlet.FilterRegistration (non-Dynamic) → adapter.jakarta.servlet6.FilterRegistration
        ...
        assertTrue(result4 instanceof adapter.jakarta.servlet6.FilterRegistration,
            "분기 4 (FilterRegistration) 는 jakarta FilterRegistration 어댑터로 dispatch 되어야 한다 "
            + "(actual=" + result4.getClass().getName() + ")");
        assertTrue(!(result4 instanceof adapter.jakarta.servlet6.FilterRegistrationDynamic),
            "분기 4 는 non-Dynamic 분기여야 한다 (Dynamic 으로 잘못 dispatch 되면 분기 3 이 선점된 것)");

        // ---- 분기 5: javax.servlet.Registration.Dynamic (base Dynamic) → adapter.jakarta.servlet6.RegistrationDynamic
        ...
        assertTrue(result5 instanceof adapter.jakarta.servlet6.RegistrationDynamic,
            "분기 5 (Registration.Dynamic base) 는 jakarta RegistrationDynamic 어댑터로 dispatch 되어야 한다 "
            + "(actual=" + result5.getClass().getName() + ")");

        // ---- 분기 6 (else / FR-CONV-010 default 분기): javax.servlet.Registration base → adapter.jakarta.servlet6.Registration
        ...
        assertTrue(result6 instanceof adapter.jakarta.servlet6.Registration,
        ...
        assertTrue(!(result6 instanceof adapter.jakarta.servlet6.RegistrationDynamic),
            "분기 6 (default) 은 어떤 sub-Dynamic 도 아니어야 한다");
        assertTrue(!(result6 instanceof adapter.jakarta.servlet6.ServletRegistration),
            "분기 6 (default) 은 ServletRegistration 으로 잘못 dispatch 되어선 안 된다");
        assertTrue(!(result6 instanceof adapter.jakarta.servlet6.FilterRegistration),
        ...
        assertSame(result1.getClass(), adapter.jakarta.servlet6.ServletRegistrationDynamic.class,
            "분기 1 결과 클래스 SSOT");
        assertSame(result2.getClass(), adapter.jakarta.servlet6.ServletRegistration.class,
            "분기 2 결과 클래스 SSOT");
        assertSame(result3.getClass(), adapter.jakarta.servlet6.FilterRegistrationDynamic.class,
            "분기 3 결과 클래스 SSOT");
        assertSame(result4.getClass(), adapter.jakarta.servlet6.FilterRegistration.class,
            "분기 4 결과 클래스 SSOT");
        assertSame(result5.getClass(), adapter.jakarta.servlet6.RegistrationDynamic.class,
            "분기 5 결과 클래스 SSOT");
        assertSame(result6.getClass(), adapter.jakarta.servlet6.Registration.class,
