...
/**
 * {@link adapter.servletElementConverter6.ServletReqResConverter} 의 4 instanceof
 * 분기 라우팅 단위 테스트.
 *
 * <p>FR-FIX-008 (servlet5 에서 fix 된 cross-namespace instanceof 결함) 의 servlet6
 ...
 *
 * @req FR-TEST-001
 * @req FR-FIX-008 (servlet5 fix 의 servlet6 회귀 lock-in)
 */
