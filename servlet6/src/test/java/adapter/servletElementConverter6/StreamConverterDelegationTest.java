...
/**
 * {@link adapter.servletElementConverter6.StreamConverter} 위임 단위 테스트.
 *
 * <p>FR-FIX-001 (servlet5 에서 fix 된 read/readLine 정확 위임 결함) 의 회귀 lock-in
 * 테스트. 본 servlet6 모듈에서 동일 패턴이 재발하지 않도록 영구 가드한다.
 ...
 *
 * @req FR-TEST-001
 * @req FR-FIX-001 (servlet5 fix 의 servlet6 회귀 lock-in)
 * @req FR-FIX-008 (cross-module consistency 가드 — InstanceofBranchDefectTest 의
 *                  servlet6 등가는 본 패키지의 ServletReqResConverterBranchTest 에서 cover)
 */
