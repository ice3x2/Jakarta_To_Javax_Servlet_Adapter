...
/**
 * BM05 — servlet6 mirror of servlet5 BugMuseum BM05 (FR-FIX-003).
 *
 * adapter.jakarta.servlet6.ServletResponse.setContentLengthLong must delegate to origin's
...
class BM05Test {
    ...
    void shouldReproduceBug05() {
        ...
        adapter.jakarta.servlet6.ServletResponse adapterResp =
            new adapter.jakarta.servlet6.ServletResponse(origin);
