...
/**
 * BM07 — servlet6 mirror of servlet5 BugMuseum BM07 (FR-FIX-009).
 *
 * adapter.jakarta.servlet6.http.HttpServletRequest.getCookies must tolerate the origin returning
...
class BM07Test {
    ...
    void shouldReproduceBug07() {
        ...
        adapter.jakarta.servlet6.http.HttpServletRequest adapterReq =
