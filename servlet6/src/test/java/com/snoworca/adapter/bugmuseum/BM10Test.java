...
/**
 * BM10 — servlet6 mirror of servlet5 BugMuseum BM10 (NFR-CONV-001 / D12 single-thread sync lock-in).
 *
 * adapter.javax.servlet6.http.HttpUpgradeHandler uses a static ThreadLocal to pass the jakarta
...
class BM10Test {
    ...
    void shouldReproduceBug10() throws Exception {
        ...
        adapter.javax.servlet6.http.HttpUpgradeHandler.setJakartaUpgradeHandlerClass(
        ...
        adapter.javax.servlet6.http.HttpUpgradeHandler instance =
            new adapter.javax.servlet6.http.HttpUpgradeHandler();
