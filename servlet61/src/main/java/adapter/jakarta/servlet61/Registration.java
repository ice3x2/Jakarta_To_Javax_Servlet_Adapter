...
public class Registration implements jakarta.servlet.Registration, AdapterUnwrap<javax.servlet.Registration> {
   ...
   // @req FR-CONV-003
   @Override public javax.servlet.Registration unwrap() {
