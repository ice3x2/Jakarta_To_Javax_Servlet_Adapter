...
public class ServletContext implements javax.servlet.ServletContext, AdapterUnwrap<jakarta.servlet.ServletContext> {
   ...
   // @req FR-CONV-003
   @Override public jakarta.servlet.ServletContext unwrap() {
   ...
   @Override public Servlet getServlet(String name) throws ServletException {
      // placeholder pending PH-004 — getServlet removed in Servlet 6.0
      return null;
   }

   @Override public Enumeration<Servlet> getServlets() {
      // placeholder pending PH-004 — getServlets removed in Servlet 6.0
      return java.util.Collections.emptyEnumeration();
   }

   @Override public Enumeration<String> getServletNames() {
      // placeholder pending PH-004 — getServletNames removed in Servlet 6.0
      return java.util.Collections.emptyEnumeration();
   }
   ...
   @Override public void log(Exception exception, String msg) {
      // placeholder pending PH-004 — log(Exception, String) removed in Servlet 6.0; fallback to log(msg, throwable)
