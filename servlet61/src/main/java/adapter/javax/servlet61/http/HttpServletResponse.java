...
import adapter.javax.servlet61.ServletResponse;
...
import javax.servlet.ServletOutputStream;
 ...
 public class HttpServletResponse extends ServletResponse implements javax.servlet.http.HttpServletResponse {
   private final jakarta.servlet.http.HttpServletResponse httpResponse;
   ...
   @Override public void addCookie(javax.servlet.http.Cookie cookie) {
      this.httpResponse.addCookie(new adapter.jakarta.servlet61.http.Cookie(cookie));
   }
   ...
   @Override public String encodeRedirectUrl(String url) {
      // placeholder pending PH-004 — encodeRedirectUrl removed in Servlet 6.0; fallback to URL variant
      return this.httpResponse.encodeRedirectURL(url);
   }
   ...
   @Override public void setStatus(int sc, String sm) {
      // placeholder pending PH-004 — setStatus(int, String) removed in Servlet 6.0; fallback drops message
      this.httpResponse.setStatus(sc);
   }
