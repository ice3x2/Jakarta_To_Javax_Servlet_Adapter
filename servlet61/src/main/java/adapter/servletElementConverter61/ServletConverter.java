...
public class ServletConverter {
   ...
   public static jakarta.servlet.Registration convert(javax.servlet.Registration ori) {
      if (ori instanceof javax.servlet.ServletRegistration.Dynamic) {
         return new adapter.jakarta.servlet61.ServletRegistrationDynamic((javax.servlet.ServletRegistration.Dynamic)ori);
      } else if (ori instanceof javax.servlet.ServletRegistration) {
         return new adapter.jakarta.servlet61.ServletRegistration((javax.servlet.ServletRegistration)ori);
      } else if (ori instanceof javax.servlet.FilterRegistration.Dynamic) {
         return new adapter.jakarta.servlet61.FilterRegistrationDynamic((javax.servlet.FilterRegistration.Dynamic)ori);
      } else if (ori instanceof javax.servlet.FilterRegistration) {
         return new adapter.jakarta.servlet61.FilterRegistration((javax.servlet.FilterRegistration)ori);
      } else {
         return ori instanceof javax.servlet.Registration.Dynamic ? new adapter.jakarta.servlet61.RegistrationDynamic((javax.servlet.Registration.Dynamic)ori) : new adapter.jakarta.servlet61.Registration(ori);
      }
   }


   public static adapter.jakarta.servlet61.ServletRegistrationDynamic convert(javax.servlet.ServletRegistration.Dynamic ori) {
      return new adapter.jakarta.servlet61.ServletRegistrationDynamic(ori);
   }

   public static adapter.jakarta.servlet61.ServletRegistration convert(javax.servlet.ServletRegistration ori) {
      return new adapter.jakarta.servlet61.ServletRegistration(ori);
   }

   public static adapter.jakarta.servlet61.FilterRegistrationDynamic convert(javax.servlet.FilterRegistration.Dynamic ori) {
      return new adapter.jakarta.servlet61.FilterRegistrationDynamic(ori);
   }

   public static adapter.jakarta.servlet61.FilterRegistration convert(javax.servlet.FilterRegistration ori) {
      return new adapter.jakarta.servlet61.FilterRegistration(ori);
   }

   public static adapter.jakarta.servlet61.RegistrationDynamic convert(javax.servlet.Registration.Dynamic ori) {
      return new adapter.jakarta.servlet61.RegistrationDynamic(ori);
   }
   ...
   public static javax.servlet.Registration convert(jakarta.servlet.Registration ori) {
      if (ori instanceof jakarta.servlet.ServletRegistration.Dynamic) {
         return new adapter.javax.servlet61.ServletRegistrationDynamic((jakarta.servlet.ServletRegistration.Dynamic)ori);
      } else if (ori instanceof jakarta.servlet.ServletRegistration) {
         return new adapter.javax.servlet61.ServletRegistration((jakarta.servlet.ServletRegistration)ori);
      } else if (ori instanceof jakarta.servlet.FilterRegistration.Dynamic) {
         return new adapter.javax.servlet61.FilterRegistrationDynamic((jakarta.servlet.FilterRegistration.Dynamic)ori);
      } else if (ori instanceof jakarta.servlet.FilterRegistration) {
         return new adapter.javax.servlet61.FilterRegistration((jakarta.servlet.FilterRegistration)ori);
      } else {
         return ori instanceof jakarta.servlet.Registration.Dynamic ? new adapter.javax.servlet61.RegistrationDynamic((jakarta.servlet.Registration.Dynamic)ori) : new adapter.javax.servlet61.Registration(ori);
      }
   }

   public static javax.servlet.ServletRegistration convert(jakarta.servlet.ServletRegistration.Dynamic ori) {
      return new adapter.javax.servlet61.ServletRegistrationDynamic(ori);
   }

   public static javax.servlet.ServletRegistration convert(jakarta.servlet.ServletRegistration ori) {
      return new adapter.javax.servlet61.ServletRegistration(ori);
   }

   public static javax.servlet.FilterRegistration convert(jakarta.servlet.FilterRegistration.Dynamic ori) {
      return new adapter.javax.servlet61.FilterRegistrationDynamic(ori);
   }

   public static javax.servlet.FilterRegistration convert(jakarta.servlet.FilterRegistration ori) {
      return new adapter.javax.servlet61.FilterRegistration(ori);
   }
   ...
   public static javax.servlet.FilterConfig convert(final jakarta.servlet.FilterConfig filterConfig) {
      return new javax.servlet.FilterConfig() {
         ...
         public javax.servlet.ServletContext getServletContext() {
            return new adapter.javax.servlet61.ServletContext(filterConfig.getServletContext());
         }
   ...
   public static jakarta.servlet.FilterConfig convert(final javax.servlet.FilterConfig filterConfig) {
      return new jakarta.servlet.FilterConfig() {
         ...
         public jakarta.servlet.ServletContext getServletContext() {
            return new adapter.jakarta.servlet61.ServletContext(filterConfig.getServletContext());
         }
   ...
   public static jakarta.servlet.ServletConfig convert(final javax.servlet.ServletConfig config) {
      return new jakarta.servlet.ServletConfig() {
         ...
         public jakarta.servlet.ServletContext getServletContext() {
            return new adapter.jakarta.servlet61.ServletContext(config.getServletContext());
         }
   ...
   public static javax.servlet.ServletConfig convert(final jakarta.servlet.ServletConfig config) {
      return new javax.servlet.ServletConfig() {
         ...
         public javax.servlet.ServletContext getServletContext() {
            return new adapter.javax.servlet61.ServletContext(config.getServletContext());
         }
