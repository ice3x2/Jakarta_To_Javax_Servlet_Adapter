...
/**
 * BM02 — servlet61 mirror of servlet5 BugMuseum BM02 (FR-FIX-002).
 *
 * adapter.jakarta.servlet61.http.Part.getSubmittedFileName must delegate to the wrapped origin
 * Part.getSubmittedFileName, not self-recurse. Regression for jakarta 6.1.
 *
 * @req FR-TEST-004
 */
class BM02Test {
    ...
    void shouldReproduceBug02() throws Exception {
        ...
        // adapter.jakarta.servlet61.http.Part has a package-default constructor; access via reflection.
        Class<?> adapterClass = Class.forName("adapter.jakarta.servlet61.http.Part");
