...
/**
 * BM09 — servlet61 mirror of servlet5 BugMuseum BM09 (FR-FIX-006).
 *
 * adapter.jakarta.servlet61.ServletRequest.getContentLengthLong must delegate directly without
...
class BM09Test {
    ...
    void shouldReproduceBug09() {
        ...
        adapter.jakarta.servlet61.ServletRequest adapterReq =
            new adapter.jakarta.servlet61.ServletRequest(origin);
