...
/**
 * IT14 — {@code jakarta.servlet.ServletConnection} fallback integration test (servlet61 module).
 *
 ...
 * by the adapter's jakarta {@link adapter.jakarta.servlet61.ServletRequest} to expose the jakarta
 * 6.1 surface. The test verifies that the adapter's synthesized {@code ServletConnection}
...
class IT14ServletConnectionTest {
     ...
     * adapter.jakarta.servlet61.ServletRequest} (which wraps the dispatched javax request) and
    ...
    static final class ConnectionProbeServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp)
            ...
            // to access the jakarta 6.1 surface (getServletConnection() — absent from javax).
            adapter.jakarta.servlet61.ServletRequest jakartaReq =
                    new adapter.jakarta.servlet61.ServletRequest(req);
