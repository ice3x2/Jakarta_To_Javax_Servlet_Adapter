...
/**
 * Tomcat embed runner for servlet61 module integration tests.
 *
 * <p>Boots a Tomcat 11.0.x instance on a random free port with a temporary base directory.
...
public final class TomcatRunner implements AutoCloseable {
    ...
    public TomcatRunner() throws IOException {
        this.baseDir = Files.createTempDirectory("tomcat-embed-servlet61-");
